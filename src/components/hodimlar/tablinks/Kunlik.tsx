...
import { deleteSelected } from '@/store/hodimlarSlice/kunlikSlice';
...
const Kunlik: React.FC<PropsType> = ({ count, setCount }) => {
	const dispatch = useDispatch();

	// Fetch the items from the Redux store
	const items = useSelector((state: RootState) => state.kunlik.items); // Adapt to your state structure
